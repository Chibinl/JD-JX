...
[task_local]
#盲盒抽京豆
1 7 * * * https://raw.githubusercontent.com/Chibinl/JD-JX/main/wl_jd_mh.js, tag=盲盒抽京豆, enabled=true

================Loon==============
[Script]
cron "1 7 * * *" script-path=https://raw.githubusercontent.com/Chibinl/JD-JX/main/wl_jd_mh.js,tag=盲盒抽京豆

===============Surge=================
盲盒抽京豆 = type=cron,cronexp="1 7 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/Chibinl/JD-JX/main/wl_jd_mh.js

============小火箭=========
盲盒抽京豆 = type=cron,script-path=https://raw.githubusercontent.com/Chibinl/JD-JX/main/wl_jd_mh.js, cronexpr="1 8,12,18* * *", timeout=200, enable=true
 */
const $ = new Env('盲盒抽京豆');
