...
[task_local]
#环球挑战赛
0 9,12,20,21 * * * https://raw.githubusercontent.com/Chibinl/JD-JX/main/jd_global.js, tag=环球挑战赛, img-url=https://raw.githubusercontent.com/yogayyy/Scripts/main/Icon/lxk0301/jd_global.png, enabled=true

================Loon==============
[Script]
cron "0 9,12,20,21 * * *" script-path=https://raw.githubusercontent.com/Chibinl/JD-JX/main/jd_global.js,tag=环球挑战赛

===============Surge=================
环球挑战赛 = type=cron,cronexp="0 9,12,20,21 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Chibinl/JD-JX/main/jd_global.js

============小火箭=========
环球挑战赛 = type=cron,script-path=https://raw.githubusercontent.com/Chibinl/JD-JX/main/jd_global.js, cronexpr="0 9,12,20,21 * * *", timeout=3600, enable=true
 */
const $ = new Env('环球挑战赛');
...
const inviteCodes = [
  'OE90L0dnQW1uYWhzTnlrTDZ2RS9Udz09@ekdnTnpURkltT2JmdUUrWFp1aG5tZz09@S2tETnZ0REtONy9Dc2Nqek1KNXpmWHFTNnF3OUtQQjJKZmJ2YUtSS3BQTT0=@dzJ2N0JOc3hDbUdINVJSdG1hcThMbTJXb2VhRjZrUmtBWjNlRTVMS1Q0dz0=@UkJDS1pGbGxmTVhGQys5dUdvZDlaZz09@M0JxTFVEbmxtV05uQWJVQVdyL2NxeTcycG1lcWtEbzVOc283bjR2MklkWT0=',
  'dzJ2N0JOc3hDbUdINVJSdG1hcThMbTJXb2VhRjZrUmtBWjNlRTVMS1Q0dz0=@UkJDS1pGbGxmTVhGQys5dUdvZDlaZz09@OE90L0dnQW1uYWhzTnlrTDZ2RS9Udz09@ekdnTnpURkltT2JmdUUrWFp1aG5tZz09@S2tETnZ0REtONy9Dc2Nqek1KNXpmWHFTNnF3OUtQQjJKZmJ2YUtSS3BQTT0=',
];
$.invites = [];
!(async () => {
  await requireConfig();
